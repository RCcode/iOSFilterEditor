...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        ME_Button *cross_btn = [[ME_Button alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(_frame) - 40.f, CGRectGetWidth(frame)/2.f, 40)];
        cross_btn.tag = 1;
        ...
        [self addSubview:cross_btn];
        
        ME_Button *check_btn = [[ME_Button alloc] initWithFrame:CGRectMake(CGRectGetWidth(frame)/2.f, CGRectGetHeight(_frame) - 40.f, CGRectGetWidth(frame)/2.f, 40)];
        check_btn.tag = 2;
