...
#import "FC_GrayFilter.h"
NSString *const KFCGrayShaderString = SHADER_STRING
(
...
@implementation FC_GrayFilter
- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:KFCGrayShaderString]))
    {
		return nil;
    }
    return self;
